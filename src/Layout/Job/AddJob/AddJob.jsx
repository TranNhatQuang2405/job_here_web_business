      ...
      <Form onSubmit={handleSubmit}>
        <Row>
          <Col className="mb-2">
            <Form.Label htmlFor="companyId">
              {t("business.company.add.companyName")}: <b>{listCompany[0].companyName}</b>
            </Form.Label>
          </Col>
        </Row>
        <Row>
          ...
          <Col xs={12} className="mb-2">
            ...
            <div
              ...
              dangerouslySetInnerHTML={{
                __html: jobInfo.description || t("business.manage.addJob.description"),
              }}
            ></div>
          </Col>
          <Col xs={12} className="mb-2">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Button type="submit" className="ms-2">
            {saving ? <Spinner animation="border" /> : t("business.manage.addJob.create")}
          </Button>
        </div>
      </Form>
    </div>
