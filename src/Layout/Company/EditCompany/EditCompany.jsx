...
const EditCompany = () => {
  ...
  const handleCloseModalEditHeader = (data) => {
    const { companyName, address, size, email, urlCompany } = data;
    setCompanyInfo((prev) => {
      return {
        ...prev,
        companyName,
  ...
  return (
    <Form>
      ...
      <div className="editCompany__button-bound">
        <Button className="me-3" variant="danger" onClick={handleClose}>
          ...
          <span className="manageCompany__buttonAdd-content">
            {t("business.company.edit.btnCancel")}
          </span>
        </Button>
        ...
        <Button onClick={handleSave} disabled={loadingSave}>
          {loadingSave ? (
            ...
            <>
              ...
              <span className="manageCompany__buttonAdd-content">
                {t("business.company.edit.btnSave")}
              </span>
            </>
          )}
        </Button>
      ...
      <EditHeaderModal
        companyInfoParent={companyInfo}
        show={showEditHeader}
        handleClose={handleCloseModalEditHeader}
      />
        ...
        <div className="CompanyPage__header jh-container jh-box-item mb-3">
          ...
          <div className="CompanyPage__company-detail-overview">
                ...
                {uploadPending.avatar ? (
                  <div className="editCompany__loadingAvatar">
                    <Spinner
                      animation="border"
                      variant="light"
                      className="editCompany__loadingAvatar-child"
                    />
                  </div>
                ) : (
                  <></>
            ...
            <div className="CompanyPage__company-header-info flex-grow-1">
              ...
              <div className="d-flex">
                {!!companyInfo.urlCompany && (
                  <p className="CompanyPage__website">
                    ...
                    <a href={companyInfo.valid_urlCompany} rel="noreferrer">
              ...
              <div>
                <div
                  className="editCompany__editHeader"
          ...
          <Row>
            <Col className="companyInfo__body-left">
              <div>
                ...
                ></div>
                <div
                  className="editCompany__editContent"
